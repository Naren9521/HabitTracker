...
const App = () => {
  ...
  const maxValues = { water: 5000, steps: 10000, yoga: 120, swim: 24 }; // Define maximum values
  ...
  return (
    <div className="widget-container">
      ...
      <div className="activity-card water-card">
        ...
        <div className="progress-bar" style={{ width: getProgress(waterAmount, maxValues.water) }}></div>
      </div>
      ...
      <div className="activity-card steps-card">
        ...
        <div className="progress-bar" style={{ width: getProgress(stepCount, maxValues.steps) }}></div>
      </div>
      ...
      <div className="activity-card yoga-card">
        ...
        <p>Yoga</p>
        <h4>{yogaTime} min</h4>
        <div className="progress-bar" style={{ width: getProgress(yogaTime, maxValues.yoga) }}></div>
      </div>
      ...
      <div className="activity-card swim-card">
        ...
        <p>Swim</p>
        <h4>{swimTime} hrs</h4>
        <div className="progress-bar" style={{ width: getProgress(swimTime, maxValues.swim) }}></div>
      </div>
